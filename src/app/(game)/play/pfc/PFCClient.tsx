...
import { MOVES, type PFCMove } from "./components/moves";
import { FaceDownCard } from "./components/FaceDownCard";
import { ChoiceButtons, MyChoiceLocked } from "./components/ChoiceButtons";
...
export function PFCClient({ gameId, myId, p1Id, p2Id, p1Pseudo, p2Pseudo, p1AvatarUrl, p2AvatarUrl, initialState, initialStatus }: Props) {
  ...
  useGamePresence({ gameId, myId, myPseudo, gameType: "pfc", initialFinished: initialStatus === "finished", isFinishedRef: isGameFinishedRef });
      ...
      {(phase === "picking" || phase === "waiting") && (
        <>
          ...
          <div style={{ position: "absolute", bottom: 50, left: 0, right: 0, padding: "0 18px", zIndex: 5 }}>
            ...
            {phase === "waiting" ? <MyChoiceLocked myMove={myMove} /> : <ChoiceButtons phase={phase} myMove={myMove} submitting={submitting} onPick={handlePick} />}
