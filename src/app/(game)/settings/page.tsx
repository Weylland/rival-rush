...
export default async function SettingsPage() {
  ...
  return (
    <div style={{ position: "relative", minHeight: "100dvh", overflow: "hidden" }}>
      <ScreenBg />
      <SvgBlob color={RR.cyan} style={{ width: 380, height: 340, top: -140, left: -100, opacity: 0.4, animation: "rr-float 8s ease-in-out infinite" }} />
      <SvgBlob color={RR.butter} style={{ width: 300, height: 280, bottom: -120, right: -80, opacity: 0.3, animation: "rr-float 10s ease-in-out infinite reverse" }} />
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: 520, margin: "0 auto", padding: "32px 20px 80px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 28 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: "var(--font-display)", fontSize: 32, color: RR.white, transform: "skewX(-8deg)", textShadow: `3px 3px 0 ${RR.pink}`, lineHeight: 1 }}>
              SETTINGS
            </div>
          </div>
        </div>
