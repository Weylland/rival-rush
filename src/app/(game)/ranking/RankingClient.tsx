...
const MEDALS = ["🥇", "🥈", "🥉"];
const TAB_LABELS: Record<Tab, string> = { global: "🏆 GLOBAL", pfc: "✊ PFC", morpion: "⨯ MORPION" };
    ...
    supabase
      ...
      .then(({ data: games }) => {
        ...
        for (const game of games) {
          ...
          const map = game.game_type === "pfc" ? pfcMap : morpionMap;
        ...
        setTypeStats({ global: new Map(), pfc: pfcMap, morpion: morpionMap });
        setTypeLoaded(true);
      });
  }, []);
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {(["global", "pfc", "morpion"] as Tab[]).map(t => (
          <button
            key={t}
            onClick={() => setTab(t)}
            style={{
